# ADR-018: Automatización TLS Wildcard y Certificados SSL vía ACME DNS-01
...
## Decisión Tomada
1. Adoptar la estrategia de infraestructura de **Let's Encrypt Wildcard** gestionado automáticamente por Traefik v3 mediante el desafío **ACME DNS-01**.
