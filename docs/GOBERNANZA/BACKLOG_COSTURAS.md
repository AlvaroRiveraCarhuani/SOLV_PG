...
| **COST-02** | Pipelines CI/CD DevSecOps | Infraestructura | Auditoría de Inventario | Implementación de flujos automatizados en `.github/workflows/ci.yml` para ejecución de tests de Go, compilación Angular y escaneo de vulnerabilidades Semgrep. | **COMPLETADO (`v0.11.5`)** |
